  ...
  return (
    <div className={`sticky ${scrollDirection === "down" ? "-top-[70px]" : "top-0"} ${!top && `shadow-lg bg-stone-100/80 backdrop-blur-md`} h-[70px] bg-stone-100 transition-all duration-500 z-[99]`}>
      <div className="navbar w-full h-full flex justify-between items-center py-4 px-6">
        ...
        >
          <a href="/">
            <img src={Logo} alt="DH" className="h-20 hover:opacity-75 transition-all ease-in duration-300 cursor-pointer" />
          </a>
        </motion.div>
          {/* NAVBAR AT 768PX & ABOVE */}
          <div>
            <ul className="hidden md:flex list-none">
              <motion.li initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 3 }} viewport={{ once: true }}><a href="#about" className="links mr-6">About Me</a></motion.li>
              <motion.li initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 3.25 }} viewport={{ once: true }}><a href="#work" className="links mx-6">Skills</a></motion.li>
          ...
          {nav ? (
            ...
            >
              ...
              <div className="h-full flex flex-col justify-center items-center">
                <a href="#about" className="mobile-links">About Me</a>
                <a href="#work" className="mobile-links">Skills</a>
                <a href="#projects" className="mobile-links">My Projects</a>
                <a href="#contact" className="mobile-links">Contact Me</a>
