      ...
      >
        <div>
          ...
          <div className="max-w-[90%] w-full mx-auto py-8 grid grid-cols-2 gap-2 sm:gap-4">
            ...
            <div className="inline-flex justify-end items-center">
              :&nbsp;<a href="mailto:ginazivkovic@gmail.com" className="text-slate-400 hover:text-slate-700">ginazivkovic@gmail.com</a>
            </div>
            <div className="inline-flex items-center">
              <GitHub className="text-slate-400" size={22} />&nbsp;GitHub
            </div>
            <div className="inline-flex justify-end items-center">
              :&nbsp;<a href="https://github.com/geezee91" target="_blank" className="text-slate-400 hover:text-slate-700">@geezee91</a>
            </div>
