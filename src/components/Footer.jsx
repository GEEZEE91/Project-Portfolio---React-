  ...
  return (
    <footer className="my-8 text-xs sm:text-sm">
      <div className="flex flex-col justify-center items-center">
        <p>Made with <Heart size={18} className="inline-flex text-slate-400" /> by <a href="https://github.com/GEEZEE91"target="_blank" className="text-slate-400 hover:text-gray-700">Gina Zivkovic</a>.</p>
      ...
      <div>
        <ul className="md:hidden flex flex-row justify-center">
          <li className="p-3 inline-flex"><a className="text-gray-800 hover:text-slate-400 hover:border-0" href="https://github.com/geezee91" target="_blank"><GitHub size={24} /></a></li>
          <li className="p-3 inline-flex"><a className="text-gray-800 hover:text-slate-400 hover:border-0" href="https://www.linkedin.com/in/gina-zivkovic/" target="_blank"><Linkedin size={24} /></a></li>
          <li className="p-3 inline-flex"><a className="text-gray-800 hover:text-slate-400 hover:border-0" href="mailto:ginazivkovic@gmail.com"><Mail size={24} /></a></li>
        </ul>
      </div>
    </footer>
  )
